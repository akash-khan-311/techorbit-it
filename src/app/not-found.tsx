...
const NotFound = () => {
  return (
    <section className="relative min-h-[calc(100vh-70px)]  overflow-hidden flex items-center justify-center mb-16 p-6">
      {/* Background elements */}
      <div>
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto">
          ...
          {/* Animated button */}
          <Link href={"/"}>
            <button className="relative px-8 py-2 transition-all duration-200 bg-[#074e4e] hover:bg-[#1b9797]  text-white font-bold rounded-lg overflow-hidden cursor-pointer">
