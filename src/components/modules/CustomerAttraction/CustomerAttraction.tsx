...
const CustomerAttraction = () => {
  ...
  return (
    <section className="w-full bg-linear-to-tr from-[#30DBDC]/20 via-[#30DBDC]/20 to-[#035A69]/20  text-white p-6 md:p-10 lg:p-16 shadow-[0px_0px_15px_0px_#1BCDD2] border border-white/10 relative overflow-hidden">
      <Container>
