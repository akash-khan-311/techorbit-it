    ...
    <div className="relative w-full " ref={comboBoxRef}>
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-2 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-100 dark:hover:text-gray-100 transition-colors"
      ...
      {isOpen && (
        <div
          id="combobox-options"
          className="absolute z-10 w-full mt-1 bg-gray-800 text-white border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-60 overflow-y-scroll"
          role="listbox"
        >
              ...
              <button
                ...
                className={`w-full px-4 py-2 text-left focus:outline-none first:rounded-t-lg last:rounded-b-lg transition-colors ${
                  index === highlightedIndex
                    ? "bg-slate-700 cursor-pointer dark:bg-blue-900/20 text-white"
                    : "text-gray-100 dark:text-gray-100 hover:bg-gray-600 dark:hover:bg-gray-700 focus:bg-gray-50 dark:focus:bg-gray-700"
                }`}
                role="option"
